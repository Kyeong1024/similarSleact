...
var UsersService = /** @class */ (function () {
    ...
    UsersService.prototype.join = function (email, password, nickname) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!email)
                            throw new common_1.HttpException('이메일이 없습니다.', 400);
                        user = this.usersRepository.findOne({ where: { email: email } });
                        if (user) {
