...
var LocalSerializer = /** @class */ (function (_super) {
    __extends(LocalSerializer, _super);
    function LocalSerializer(usersRepository, authService) {
        var _this = _super.call(this) || this;
        _this.usersRepository = usersRepository;
        _this.authService = authService;
        return _this;
    }
    LocalSerializer.prototype.serializeUser = function (user, done) {
        done(null, user.id);
    };
    LocalSerializer.prototype.deserializeUser = function (userId, done) {
